...
remove_container = bool(
    os.getenv("REMOVE_CONTAINER", os.getenv("GP_REMOVE_CONTAINER", "True")).lower() == "true"
)
swarm_mode = bool(os.getenv("DOCKER_MODE", os.getenv("GP_DOCKER_MODE", "swarm")).lower() == "swarm")
