...
class DockerSpecApp(BaseSpecApp):
    ...
    description = "Creates a Jupyter kernel specification for use within a Docker or Docker Swarm cluster."
...
class DockerProvisionerApp(Application):
    ...
    subcommands = dict({'install': (DockerSpecApp, DockerSpecApp.description.splitlines()[0]), })
    aliases = {}
    flags = {}
