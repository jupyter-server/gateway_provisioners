...
Regardless, Gateway Provisioners are deployed and configured wherever the kernel is ultimately
launched. In either case, the *hosting application* is using `jupyter_client` to launch kernels.
